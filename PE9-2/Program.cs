...
namespace PE9_2
{
    // Class: IGME 201.01
    // Author: Judy Derrick
    // Purpose: PE9 Q2 - Functions
    // Restrictions: None
    static internal class Program
    {
        // Method: Main
        // Purpose: add a timer to the Math Quiz Solution in "Lecture Code Examples" to elapse
        //          in 5 seconds for each question, and mark the answer wrong if the timer expires
        // Restrictions: None
        ...
        start:
            ...
            // 
            Console.WriteLine("Ok you have 5 seconds for each question. Good luck!");
            Console.WriteLine("");
