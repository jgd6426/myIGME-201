...
class Program
{
    // Assignment: Unit Test #1, Q.1
    // Name: Judy Derrick
    // Purpose: enhance "Math Quiz Application" to include division
    ...
    start:
        ...
        for (nCntr = 0; nCntr < nQuestions; ++nCntr)
        {
            ...
            do
            {
                ...
                if (nOp > 2)
                {
                    Console.WriteLine("Enter your answer to 2 decimal places.");
                }
                ...
                else
                {
                    try
                    {
                        nResponse = Convert.ToDouble(sResponse);
                        bValid = true;
                    }
                    catch
                    {
                        Console.WriteLine("Please round your answer to 2 decimal places.");
                        bValid = false;
                    }
                }
