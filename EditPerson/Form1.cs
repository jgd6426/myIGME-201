    ...
    public partial class PersonEditForm : Form
    {
        ...
        public PersonEditForm(Person person, Form parentForm)
        {
            ...
            */
            ...
            this.freshRadioButton.CheckedChanged += new EventHandler(this.FreshRadioButton__CheckedChanged);
            this.sophRadioButton.CheckedChanged += new EventHandler(this.SophRadioButton__CheckedChanged);
            this.juniorRadioButton.CheckedChanged += new EventHandler(this.JuniorRadioButton__CheckedChanged);
            this.seniorRadioButton.CheckedChanged += new EventHandler(this.SeniorRadioButton__CheckedChanged);
        ...
        private void TypeComboBox__SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                this.classGroupBox.Enabled = false;
            }
        }
        ...
        private void FreshRadioButton__CheckedChanged(object sender, EventArgs e)
        {
            RadioButton rb = (RadioButton)sender;
            if (rb.Checked)
            {
        ...
        private void SophRadioButton__CheckedChanged(object sender, EventArgs e)
        {
            RadioButton rb = (RadioButton)sender;
            if (rb.Checked)
            {
        ...
        private void JuniorRadioButton__CheckedChanged(object sender, EventArgs e)
        {
            RadioButton rb = (RadioButton)sender;
            if (rb.Checked)
            {
        ...
        private void SeniorRadioButton__CheckedChanged(object sender, EventArgs e)
        {
            RadioButton rb = (RadioButton)sender;
            if (rb.Checked)
            {
        ...
        private void OkButton__Click(object sender, EventArgs e)
        {
            ...
            if ( person.GetType() == typeof( Student))
            {
                ...
                if (freshRadioButton.Checked)
                {
                    student.eCollegeYear = collegeYear.freshman;
                }
                else if (sophRadioButton.Checked)
                {
